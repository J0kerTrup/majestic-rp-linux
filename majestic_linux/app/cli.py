...
from .commands import cmd_clean, cmd_config, cmd_detect, cmd_doctor, cmd_doctor_radio, cmd_env, cmd_patch, cmd_purge_majestic, cmd_run
...
def build_parser() -> argparse.ArgumentParser:
    ...
    for command in ("doctor", "doctor-radio", "config", "detect", "env", "dry-run", "patch", "clean", "purge-majestic"):
